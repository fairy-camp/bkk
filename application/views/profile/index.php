...
<div class="content-wrapper" style="margin-top: -5px">
    ...
    <div class="card card-widget widget-user" style="height: 552px;">
        <!-- Add the bg color to the header using any of the bg-* classes -->
        <div class="widget-user-header bg-olive" style="height: 250px">
            <h1 class="widget-user-username mt-5" style="font-size: 30pt"><?= $user['nama'] ?></h1>
            <h5 class="widget-user-desc mb-5"><?= $role['role'] ?></h5>
        </div>
