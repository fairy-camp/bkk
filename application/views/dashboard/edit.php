                                ...
                                <div class="form-group form-inline">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="custom-select mx-1 float-right w-100" name="tahun" id="tahun">
                                            <option value="2006" <?= ($alumni['tahun_lulus'] == '2006' ? ' selected' : '') ?>>2006</option>
                                            <option value="2007" <?= ($alumni['tahun_lulus'] == '2007' ? ' selected' : '') ?>>2007</option>
                                            <option value="2008" <?= ($alumni['tahun_lulus'] == '2008' ? ' selected' : '') ?>>2008</option>
                                            <option value="2009" <?= ($alumni['tahun_lulus'] == '2009' ? ' selected' : '') ?>>2009</option>
                                            <option value="2010" <?= ($alumni['tahun_lulus'] == '2010' ? ' selected' : '') ?>>2010</option>
                                            <option value="2011" <?= ($alumni['tahun_lulus'] == '2011' ? ' selected' : '') ?>>2011</option>
                                            <option value="2012" <?= ($alumni['tahun_lulus'] == '2012' ? ' selected' : '') ?>>2012</option>
                                            <option value="2013" <?= ($alumni['tahun_lulus'] == '2013' ? ' selected' : '') ?>>2013</option>
                                ...
                                <div class="form-group form-inline">
                                    ...
                                    <div class="col-sm-8 px-3">
                                        <div class="row">
                                            ...
                                            <img src="<?= base_url('assets/img/alumni/') . $alumni['upload_foto'] ?>" width="90px" style="border-radius: 5px">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group form-inline">
