                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        <div class="text-center">
                            <img class="profile-user-img" src="<?= base_url('assets/img/alumni/') . $alumni['upload_foto'] ?>" alt="User profile picture">
                        </div>
                        <h3 class="profile-username text-center"><?= $alumni['nama_alumni'] ?></h3>
                        <h4 class="profile-username text-center"><?= $alumni['nis'] ?></h4>
