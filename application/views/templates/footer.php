    ...
    $(function() {
        ...
        var areaChartData = {
            ...
            datasets: [{
                ...
                data: [
                    <?php
                    $satu = $this->db->get_where('alumni', ['tahun_lulus' => '2006'])->num_rows();
                    echo $satu;
                    ?>,
                    <?php
                    $satu = $this->db->get_where('alumni', ['tahun_lulus' => '2007'])->num_rows();
                    echo $satu;
                    ?>,
                    <?php
                    $satu = $this->db->get_where('alumni', ['tahun_lulus' => '2008'])->num_rows();
                    echo $satu;
                    ?>,
                    <?php
                    $satu = $this->db->get_where('alumni', ['tahun_lulus' => '2009'])->num_rows();
                    echo $satu;
                    ?>,
                    <?php
                    $satu = $this->db->get_where('alumni', ['tahun_lulus' => '2010'])->num_rows();
                    echo $satu;
                    ?>,
                    <?php
                    $satu = $this->db->get_where('alumni', ['tahun_lulus' => '2011'])->num_rows();
                    echo $satu;
                    ?>,
                    <?php
                    $satu = $this->db->get_where('alumni', ['tahun_lulus' => '2012'])->num_rows();
                    echo $satu;
                    ?>,
                    <?php
                    $satu = $this->db->get_where('alumni', ['tahun_lulus' => '2013'])->num_rows();
                    echo $satu;
                    ?>,
                    <?php
                    $satu = $this->db->get_where('alumni', ['tahun_lulus' => '2014'])->num_rows();
                    echo $satu;
                    ?>,
                    <?php
